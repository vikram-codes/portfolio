        ...
        <div className="space-y-16">
          {portfolioProjects.map((project, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 shadow-md overflow-hidden transition-all duration-500 hover:border-white/20 flex flex-col max-w-3xl mx-auto"
            >
              {/* Image */}
